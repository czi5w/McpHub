...
class SettingsStore(
    ...
    companion object {
        ...
        // Floating Window
        val FLOATING_WINDOW_MODE = booleanPreferencesKey("floating_window_mode")
    }
    ...
    val settingsFlowRaw = dataStore.data
        .catch { exception ->
            ...
            Settings(
                ...
                floatingWindowMode = preferences[FLOATING_WINDOW_MODE] == true,
            )
        }
        .map {
    ...
    suspend fun update(settings: Settings) {
        ...
        dataStore.edit { preferences ->
            ...
            preferences[FLOATING_WINDOW_MODE] = settings.floatingWindowMode
        }
    }
...
data class Settings(
    ...
    val floatingWindowMode: Boolean = false
) {
    companion object {
